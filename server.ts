...
// Support larger audio payloads for audio transcription
 ...
 */
app.post("/api/lyrics/generate-sync", async (req, res) => {
  try {
 ...
 */
app.post("/api/lyrics/sync-text", async (req, res) => {
  try {
...
async function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`HAMA PRO EDITING Server running on http://0.0.0.0:${PORT}`);
  });
}
